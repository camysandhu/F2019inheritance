...
public class FullTimeFaculity extends Faculity {

    private float bonus;

    public FullTimeFaculity(int id) {
        super(id);
    }

    public FullTimeFaculity(int id, String firstName, String lastName, LocalDate birthDate, String gender, String designation, float salary, String specialization, float bonus) {
